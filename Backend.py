...
engine2 = create_engine("sqlite:///sqlite3.db", encoding='utf-8')  # To final say the SQLAlchemy engine is created with Sqlite3
#data_stock.to_sql('data_stock', con=engine2, if_exists='replace', index=False)
data_target.to_sql('data_target', con=engine2, if_exists='replace', index=False)
